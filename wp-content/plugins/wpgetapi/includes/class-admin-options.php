...
class WpGetApi_Admin_Options {
	...
	public function setup_fields() {
		...
		$fields[] = array(
		    ...
		    'fields'     => array(
				array(
				    'name' => __( 'API Name', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The name of this API. Call it whatever you like.', 'wpgetapi' ) . '"></span>',
				    'id'   => 'name',
				    'type' => 'text',
				    'attributes' => array( 
				    	'required' => true,
				...
				array(
				    'name' => __( 'Unique ID', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Choose your own unique ID for this API. Use lowercase letters and underscores only!', 'wpgetapi' ) . '"></span>',
				    'id'   => 'id',
				    'type' => 'text',
				    'attributes' => array( 
				    	'required' => true,
				...
				array(
				    'name' => __( 'Base URL', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The base URL of the API you are connecting to.', 'wpgetapi' ) . '"></span>',
				    'id'   => 'base_url',
				    'type' => 'text',
				    'attributes' => array( 
				    	'required' => true,
	...
	public function endpoint_fields( $type = '', $api_id = '', $base_url = '' ) {
		...
		$cache_url = $this->pro_plugin ? '<a target="_blank" href="https://wpgetapi.com/docs/caching-api-calls/">Caching Help</a>' : '<a target="_blank" href="https://wpgetapi.com/downloads/pro-plugin/?utm_campaign=Cache Pro Plugin&utm_medium=Admin&utm_source=User">PRO Feature<span class="dashicons dashicons-external"></span></a>';

		$endpoint_fields = apply_filters( 'wpgetapi_fields_endpoints', array(
			array(
			    'name' => __( 'Unique ID', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Choose your own unique ID for this endpoint. Use lowercase letters and underscores only!', 'wpgetapi' ) . '"></span>',
			    'id'   => 'id',
			    'type' => 'text',
			    'classes' => 'field-id',
			    'attributes' => array( 
			...
			array(
			    'name' => __( 'Endpoint', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'This Endpoint will be appended to the Base URL to create the full URL that will be called.', 'wpgetapi' ) . '"></span>',
			    'id'   => 'endpoint',
			    'type' => 'text',
			...
			array(
			    'name' => __( 'Method', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'The Request Method for this endpoint. If you are displaying data from the API, it will usually be GET. If you are sending to the API, it will usually be POST.', 'wpgetapi' ) . '"></span>',
			    'id'   => 'method',
			    'type' => 'select',
			...
			array(
			    'name' => __( 'Results Format', 'wpgetapi' ) . 
			    	'<span class="dashicons dashicons-editor-help" data-tip="' . 
			    		sprintf( 
	            			__( 'The format that the API data will be returned in. To format the data as HTML, click the link below to learn how. %1s', 'wpgetapi' ),
			...
			array(
			    'name' => __( 'Query String', 'wpgetapi' ) . 
			    	'<span class="dashicons dashicons-editor-help" data-tip="' . 
			    		sprintf( 
	            			__( 'Parameters as name/value pairs that will be appended to the URL. The query string is the part of the URL after the question mark, like so: https://yoururl.com<b>?key=value&key3=value3</b> %1s', 'wpgetapi' ),
			...
			array(
			    'name' => __( 'Encode Body', 'wpgetapi' ) . '<span class="dashicons dashicons-editor-help" data-tip="' . __( 'Encoding of the above Body parameters.', 'wpgetapi' ) . '"></span>',
			    'id'   => 'body_json_encode',
			    'type' => 'select',
			    ...
			    'options' => array(
			        ...
			        'xml'   => __( 'XML format (available in PRO only)', 'wpgetapi' ), 
			    ),
			    'desc' => '',
			),
	    ) );
	...
	public function add_options_pages() {
		...
		foreach ($option_tabs as $index => $option_tab) {
			if ( $index == 0) {
				...
				$this->options_pages[] = add_menu_page( $this->title, $this->menu_title, 'manage_options', $option_tab['id'], array( $this, 'admin_page_display' ), 'none'
		...
		<div class="wrap wpgetapi">
			...
			<div class="main_content_cell">
				...
				<h1 class="wp-heading-inline">
					<img width="24" height="22" src="<?php echo esc_url( WPGETAPIURL . 'assets/img/wpgetapi-icon.png' ); ?>" /> <?php esc_html_e( $this->title, 'wpgetapi' ) ?> <span class="vnum"><?php echo WPGETAPIVERSION; ?></span>
				</h1>
		...
		jQuery(document).ready(function($) {
			...
			$('body').on( 'click', '.wpgetapi-test-area .test-button', function(){//delegated
				...
				jQuery.post(ajaxurl, data, function( response ) {
					...
					jQuery( '.wpgetapi-test-area[data-endpoint="' + output.endpoint_id + '"] .wpgetapi-result' ).html( output.data);
	...
	public function sidebar_display() {
		...
		?>
			...
			<div class="box">
                <strong><?php esc_html_e( 'Endpoint Instructions', 'wpgetapi' ); ?></strong>
                <ol>
                	...
                	<li><?php _e( 'Other fields are optional & will depend on your API', 'wpgetapi' ); ?></li>
                	<li><?php _e( 'Hit the Save button', 'wpgetapi' ); ?></li>
                	<li><?php _e( 'Copy the Template Tag or Shortcode & paste into page, post or theme file', 'wpgetapi' ); ?></li>
                </ol>
            </div>
            ...
            <hr> 
           	...
           	<div class="box">    
                ...
                <ul>
					...
					<li><?php 
					printf(
						esc_html__( 'Do more with the %1$s', 'cmb2' ),
						'<a target="_blank" href="https://wpgetapi.com/downloads/pro-plugin/?utm_campaign=Pro&utm_medium=Admin&utm_source=User">PRO Plugin</a>'
					);
					?></li>
                </ul>  
            </div>
    ...
    public function sidebar_setup_page() {
        ...
        ?>
            ...
            <div class="box">
                <strong><?php esc_html_e( 'Setup Instructions', 'wpgetapi' ); ?></strong>
                <ol>
                	<li><?php _e( 'Name your API in the <b>API Name</b> field', 'wpgetapi' ); ?></li>
                	<li><?php _e( 'Give your API a <b>Unique ID</b>', 'wpgetapi' ); ?></li>
                	<li><?php _e( 'Add the <b>Base URL</b> of your API. This can be found in the docs of your API', 'wpgetapi' ); ?></li>
                	<li><?php _e( 'Hit the Save button', 'wpgetapi' ); ?></li>
                	<li><?php _e( 'Visit the new tab that will be created', 'wpgetapi' ); ?></li>
                </ol>
            </div>
