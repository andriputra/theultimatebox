...
class OptimizerSettings
{
    ...
    public $settings_names = array(
        ...
        'two_change_minify'                  => array(
            ...
            'description' => '',
            'accepted_value' => array("JSMin", "Minify"),
        ),
        /*End general*/
        ...
        'two_add_overflow_to_page'           => array(
            ...
            'description' => 'If you’re encountering difficulties with the website’s scroll functionality please check the following options. Depending on the unique specifics of your situation, one of these options should effectively resolve the issue.',
            'accepted_value' => array("off", "body", "html", "body, html"),
        ),
        ...
        'lazy_load_type'                     => array(
            ...
            'accepted_value' => array("browser", "vanilla"),
        ),
        /* End lazyload*/
        ...
        'two_font_actions'                => array(
            ...
            'accepted_value' => array("default", "not_load", "exclude_uncritical_fonts"),
        ),
        /*End critical_css*/
