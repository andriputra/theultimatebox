...
if ( !in_array('dom', get_loaded_extensions()) ) {
    ...
    $two_incompatible_errors[] = array( 'title' => __('Class \'DOMDocument\' is not found in PHP:', 'tenweb-speed-optimizer'),
...
function two_init()
{
    ...
    elseif(\Tenweb_Authorization\Login::get_instance()->check_logged_in() && $global_mode_name!=="no_optimize"
